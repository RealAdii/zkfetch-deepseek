 ...
 */
export declare function generateZkWitness({ algorithm, privateInput: { key }, publicInput: { ciphertext, iv, offset }, }: GenerateWitnessOpts): Promise<{
    witness: ZKProofInput;
    plaintextArray: Uint8Array;
}>;
export declare function getPublicSignals({ proof: { algorithm, plaintext }, publicInput: { ciphertext, iv, offset }, }: GetPublicSignalsOpts): ZKProofPublicSignals;
